...
allocated_resources = C - r
Revenue = Price*allocated_resources

surf = ax.plot_surface(allocated_resources, d,Revenue, cmap=cm.coolwarm,
                       linewidth=0, antialiased=False)

ax.set_xlabel('Allocated Calls (bbu)')
ax.set_ylabel('Arrival Rate')
ax.set_zlabel('Revenue')
#ax.set_title("The Slice Revenue for allocated resources and demand")
fig.colorbar(surf, shrink=0.5, aspect=10)

#5plt.savefig("figs/Demand_Supply.png")
plt.show()
